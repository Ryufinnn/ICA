...
&nbsp;&nbsp;&nbsp;<a href="?cat=nasabah&page=nasabah" class="btn btn-medium btn-warning">Kembali</a> 
</div>
</div>
<?php
...
$nh = 'Jumlah Pinjaman Kosong' ;
	...
	$q=mysql_query("Insert into nasabah values ('".$_POST['kode']."','".$_POST['nama']."','".$_POST['umur']."','".$_POST['nohp']."','".$_POST['alamat']."','".$_POST['pendapatan']."','".$_POST['jurusan']."','".$_POST['pekerjaan']."','".$_POST['pinjaman']."','".$_POST['jangka']."','".$_POST['npwp']."','".$_POST['ktp']."','".$_POST['legal']."','".$_POST['status']."','".$_POST['keluarga']."','".$_POST['disiplin']."','".$nh."','".$namabaru."')");
	if($q)
	{
