<body onLoad="javascript:window:print()">
 <?php
  include("_db.php");
  $rw=mysql_query("select * from nasabah where kode='$_GET[id]'");
...
<tr><td>Nama Nasabah</td><td>:</td><td><?php echo $s['kode']; ?></td></tr>
	...
	<tr><td>Jaminan</td><td>:</td><td><?php echo $s['jaminan']; ?></td></tr>
