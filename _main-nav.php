...
<div class="leftmenu">
  <ul class="nav nav-tabs nav-stacked">
    ...
    <li class="active"><a href="?cat=nasabah&page=about"><span class="icon-align-justify"></span> About</a></li>
    <!--MENU GUDANG-->
    <?php
	if($_SESSION['login_hash']=="akademik")
	{
	?>
    <li><a href="?cat=nasabah&page=nasabah"><span class="icon-book"></span> Data Nasabah</a>
    ...
    <li class="dropdown"><a href="#"><span class="icon-book"></span> Laporan</a>
      <ul>
        <li><a href="?cat=nasabah&page=laporannasabah">Laporan Pemberian Pinjaman Nasabah</a></li>
      </ul>
    </li>   
	<li class="active"><a href="?cat=nasabah&page=kontak"><span class="icon-align-justify"></span> Kontak</a></li>   
	<li class="active"><a href="dashboard.php?cat=web&page=logout"><span class="icon-user"></span> Logout</a></li>     
   <!--MENU PIMPINAN-->
        <?php
